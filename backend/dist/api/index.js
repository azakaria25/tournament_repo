        ...
        try {
            ...
            for (const tournament of affectedTournaments) {
                ...
                if (tournamentDetails.teams.length >= 2) {
                    ...
                    yield databaseService.updateTournament(Object.assign(Object.assign({}, tournamentDetails), { status: 'active', pin: tournamentDetails.pin || '' }));
                }
                else {
                    // If not enough teams, update status to upcoming
                    yield databaseService.updateTournament(Object.assign(Object.assign({}, tournamentDetails), { status: 'upcoming', pin: tournamentDetails.pin || '' }));
                }
            }
        }
        catch (error) {
...
app.post('/api/tournaments/:id/start', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (USE_IN_MEMORY_STORAGE) {
            ...
            yield databaseService.updateTournament(Object.assign(Object.assign({}, tournament), { pin: tournament.pin || '' }));
...
app.put('/api/matches/:matchId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { matchId } = req.params;
    ...
    try {
        ...
        if (USE_IN_MEMORY_STORAGE) {
            ...
            if (updatedTournament && updatedTournament.teams.length >= 2) {
                ...
                // Update tournament status to active
                yield databaseService.updateTournament(Object.assign(Object.assign({}, updatedTournament), { status: 'active', pin: updatedTournament.pin || '' }));
            }
            else if (updatedTournament) {
                // If not enough teams, update status to upcoming
                yield databaseService.updateTournament(Object.assign(Object.assign({}, updatedTournament), { status: 'upcoming', pin: updatedTournament.pin || '' }));
            }
        }
        const updatedTournament = yield getTournamentDetails(tournamentId);
        res.json(updatedTournament);
...
app.put('/api/tournaments/:id/status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (USE_IN_MEMORY_STORAGE) {
            ...
            yield databaseService.updateTournament(Object.assign(Object.assign({}, tournament), { status, pin: tournament.pin || '' }));
        }
        res.json(tournament);
    }
    catch (error) {
...
function createMatches(teams, tournamentId) {
    ...
    const sortedTeams = [...teams].sort((a, b) => {
        var _a, _b;
        const weightA = (_a = a.weight) !== null && _a !== void 0 ? _a : 9999; // Teams without weight go to the end
        const weightB = (_b = b.weight) !== null && _b !== void 0 ? _b : 9999;
...
app.put('/api/tournaments/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield databaseService.updateTournament(Object.assign(Object.assign({}, tournament), { name,
        month,
        year, pin: finalPin }));
    res.json(tournament);
}));
...
app.delete('/api/tournaments', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!USE_IN_MEMORY_STORAGE) {
            yield databaseService.deleteAllTournaments();
        }
